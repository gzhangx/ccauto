    ...
    public class SwitchAccount : BaseProcessor, IAccountControl
    {
        ...
        public SwitchAccount(ProcessingContext ctx) : base(ctx)
        {
            switchSteps = new List<StepInfo>
            {
                ...
                new StepInfo { inputName= "chk_act_2psi.png", cmd = "-match googlePlaySignIn.png 6000", maxRetry = 3, name = "FindPlaySignin", xoff = 101, yoff = 63, delay = 5000, otherStepCheck = new [] { "FindPlaySigninDisconnected" } },
                ...
                new StepInfo { inputName= "chk_act_6cnf.png", cmd = "-match confirm.bmp 12000", maxRetry = 5, name = "ConfirmLoadVillage", xoff = 310, yoff = 22, Act= ConfirmLoadVillage },          
            };
        }
