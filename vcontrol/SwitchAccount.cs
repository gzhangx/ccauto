    ...
    public class SwitchAccount : BaseProcessor
    {
        ...
        public SwitchAccount(ProcessingContext ctx) : base(ctx)
        {
            switchSteps = new List<StepInfo>
            {
                ...
                new StepInfo { inputName= "chk_act_2psi.png", cmd = "-match googlePlaySignIn.png 700", maxRetry = 3, name = "FindPlaySignin", xoff = 101, yoff = 63, delay = 5000, otherStepCheck = new [] { "FindPlaySigninDisconnected" } },
                ...
                new StepInfo { inputName= "chk_act_5ldv.png", cmd = "-match loadVillage.png 700", maxRetry = 30, name = "LoadVillage", xoff = 298, yoff = 44, delay=5000 },
